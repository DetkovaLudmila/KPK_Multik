...
void DrawSun            (int x, int y, double sizex, double sizey, COLORREF sunColor);
...
void DrawTree           (int x, int y, double sizex, double sizey, COLORREF treeColor, double wind);
void DrawRain           (int x, int y, double sizex, double sizey, COLORREF cloudColor);
void StartTitles        ();
void EndTitles          ();
void DrawBackGround     ();
...
int main ()
{
    ...
    while (i >= -40)
       {
        ...
        for (int j = 1; j <= 6; j++)
        DrawFlower (150*j,  430, 3, 3, TX_LIGHTRED, TX_WHITE);
 ...
 void DrawBackGround()
 {
    ...
    DrawSun    (850,  100, 1, 1, TX_YELLOW );
    DrawCloud  ( 50,  150, 1, 1, TX_LIGHTGRAY);
    DrawCloud  (300,   50, 1, 1, TX_LIGHTGRAY);
    DrawCloud  (550,  200, 1, 1, TX_LIGHTGRAY);
...
void DrawBackGroundRain()
{
    ...
    for (int i = 0; i <= 6; i++)
    {
    DrawTree   ( 50 + 200*i,  250, 1   , 1   , TX_GREEN     , 0 );
    DrawTree   (150 + 200*i,  300, 0.75, 0.75, TX_LIGHTGREEN, 0 );
    }
    for (int i = 0; i <= 5; i++)
    {
    DrawGrib   ( 10 + 300*i,  400, 1    , 1   , TX_ORANGE   , TX_YELLOW);
 ...
 void SunDay()
{
    ...
    while (a <= 300)
    {
        ...
        for (int i = 0; i <= 6; i++)
        {
            DrawTree   ( 50 + 200*i,  250, 1   , 1   , TX_GREEN     ,  a%10 );
            DrawTree   (150 + 200*i,  300, 0.75, 0.75, TX_LIGHTGREEN, -a%10 );
        }
    ...
    while ( c <= 150 )
    {
        ...
        for (int i = 0; i <= 10; i++)
        {
            DrawFlower ( 10 + 100*i - c%5,  480 + i%3*100, 1    , 1    , TX_WHITE   , TX_YELLOW);
            DrawFlower (160 + 100*i - c%5,  530 + i%3*100, 0.75 , 0.75 , TX_BLUE    , TX_WHITE );
            DrawFlower (300 + 100*i - c%5,  580 + i%3*100, 1.2  , 1.2  , TX_LIGHTRED, TX_YELLOW);
        }
...
void RainDay()
{
    ...
    while ( a <= 500)
    {
        ...
        DrawRain (a      , 100, 2, 2, TX_BLUE);
        DrawRain (a + 350, 100, 2, 2, TX_BLUE);
        DrawRain (a + 700, 100, 2, 2, TX_BLUE);

        DrawGirl   (780 - a,  450, 1  , 1  , TX_WHITE   , TX_PINK   ,    0,    0, a%10,    0,  0);
        DrawFlower (740 - a,  450, 1.2, 1.2, TX_LIGHTRED, TX_YELLOW);
    ...
    while ( b <= 500 )
    {
        ...
        DrawRain (b      , 100, 2, 2, TX_BLUE);
        DrawRain (b + 350, 100, 2, 2, TX_BLUE);
        DrawRain (b + 700, 100, 2, 2, TX_BLUE);

        txEllipse (380, 450, 400 + b ,480 );
        txEllipse (280, 550, 300 + b ,580 );
        txEllipse (580, 500, 600 + b ,530 );
...
void DrawRain(int x, int y, double sizex, double sizey, COLORREF cloudColor)
{
    ...
    for (int i = 1; i <= 5; i++)
    {
        for (int j = 1; j <= 20; j++)
        {
        if ((i + j)%2) txLine (x + 30*i, y + 100*j, x + 30*i,y + 130*j);
        }
    }
}
void DrawSun (int x, int y, double sizex, double sizey, COLORREF sunColor)
{
    ...
    txLine   (x + (780 - 850)*sizex, y + (100 - 100)*sizey, x + (920 - 850)*sizex, y + (100 - 100)*sizey);
    txLine   (x + (850 - 850)*sizex, y + ( 30 - 100)*sizey, x + (850 - 850)*sizex, y + (170 - 100)*sizey);
    txLine   (x + (780 - 850)*sizex, y + ( 30 - 100)*sizey, x + (920 - 850)*sizex, y + (170 - 100)*sizey);
    txLine   (x + (920 - 850)*sizex, y + ( 30 - 100)*sizey, x + (780 - 850)*sizex, y + (170 - 100)*sizey);
}
...
void DrawFlower (int x, int y, double sizex, double sizey, COLORREF lepestkiColor,COLORREF serdcevinaColor)
{
    ...
    txCircle       (x + (890 - 900)*sizex, y + (500 - 520)*sizey, 10*sizex);
    txCircle       (x + (910 - 900)*sizex, y + (500 - 520)*sizey, 10*sizex);
    txCircle       (x + (900 - 900)*sizex, y + (510 - 520)*sizey, 10*sizex);
    txCircle       (x + (900 - 900)*sizex, y + (490 - 520)*sizey, 10*sizex);

    txSetColor     (serdcevinaColor);
    txSetFillColor (serdcevinaColor);
    txCircle       (x + (900 - 900)*sizex, y + (500 - 520)*sizey, 10*sizex);

    txSetColor     (TX_GREEN, 3);
    txSetFillColor (TX_GREEN);
    txLine         (x + (900 - 900)*sizex, y + (520 - 520)*sizey, x + (900 - 900)*sizex, y + (570 - 520)*sizey);
    POINT triangleList[3]=  {{x + (900 - 900)*sizex, y + (570 - 520)*sizey}, {x + (880 - 900)*sizex, y + (540 - 520)*sizey},
                             {x + (900 - 900)*sizex, y + (550 - 520)*sizey}};
    txPolygon      (triangleList, 3);
    POINT triangleListok[3]={{x + (900 - 900)*sizex, y + (570 - 520)*sizey}, {x + (920 - 900)*sizex, y + (540 - 520)*sizey},
                             {x + (900 - 900)*sizex, y + (550 - 520)*sizey}};
